...
//	$('.main-content').before('<div class="cxl_header_container"><div class="cxl_header"><div class="cxl_dr_says">Dr. Oz Says:</div>' + h1.html().substring(13) + '</div></div>');
	...
	//ul list
	$('.cxl_tab_container').after('<div class="cxl_bottle_container"><div class="cxl_bottle_text_header">Cramp Defense®: Your Solution to Stopping and Preventing Cramps</div><div class="cxl_bottle_pic"><a href="/pages/reviews"><span class="big-review-badge"><span class="spr-badge" id="spr_badge_139226889" data-rating="4.2944199706314246"><span class="spr-starrating spr-badge-starrating"><i class="spr-icon spr-icon-star" style="color: #ffe733;"></i><i class="spr-icon spr-icon-star" style="color: #ffe733;"></i><i class="spr-icon spr-icon-star" style="color: #ffe733;"></i><i class="spr-icon spr-icon-star" style="color: #ffe733;"></i><i class="spr-icon spr-icon-star-half-alt" style="color: #ffe733;"></i></span><span class="spr-badge-caption">Read Our <span class="spr-review-badge-num">1373</span> <span class="spr-review-badge-word">reviews</span></span></span></span></a></div><div class="cxl_bottle_text"><p><strong>Cramp Defense®</strong> is Unique and Not Sold in Stores. <strong>It is the Only Magnesium Supplement Designed to Restore Magnesium Quickly, Without Side Effects.</strong></p><ul><li><strong>High-Absorbing:</strong> Our form of magnesium is organic, allowing you to absorb it easily. (If your body doesn\'t absorb it, it cannot work!)</li><li><strong>Fast:</strong> It starts absorbing immediately and becomes even more effective with time.</li><li><strong>Side Effect & Weird Ingredient-Free:</strong> It causes no stomach upset or laxative effect and contains no binders, coatings or extras.</li><li><strong>Active ingredient</strong> is magnesium bound to malate. This form of magnesium is organic and natural, because it is found in fruit and vegetables.</li><li><strong>Made in the USA</strong> and manufactured in an FDA inspected facility.</li></ul></div></div>');
	...
	$('body').on('click', '.cxl_tab_container.cxl_second .cxl_plusminus', function(){
